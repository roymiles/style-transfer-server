...
def upload(request):
    if request.method == 'POST':
        ...
        unique_path = static_path(f"content/{unique_name}.png")
        ...
        style_image = load_img(static_path(f"styles/{random_style}"))
        ...
        output_path = static_path(f"styled-images/{unique_name}_{style_name}.png")
